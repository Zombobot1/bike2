...
import { getStrChanges } from '../../utils/getStrChange'
...
export function T() {
  ...
  // console.log(formatBytes(new TextEncoder().encode(data).length)) // 139KB pure data
  return null
}
...
const old = `<div class="entry-content">
...
const new_ = `<div class="entry-content">
<p><em>Age Group: 0-6 years</em></p>
...
for (let i = 0; i < 100; i++) {
  const diff = getStrChanges(old, new_)
}
